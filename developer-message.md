...
我借助 AI 辅助调试，基本定位到了 Android 13+ 上屏幕阅读器音频被抖音、微信等 App 从耳机劫持到扬声器的根因。
...
【已验证的修复方法】
通过 setCommunicationDevice(headset) 可以将通信设备强制设回耳机，覆盖掉 App 残留的错误设置。该 API 为 Android 13+ 公开 API，无需 root 权限。
